...
- X2 > Y2: 跳躍開傘上擊 (Hit:2, +Aerial:Character)
...
- Jump ↓ + X1 > Y1: 近距離生成冰柱下砸 (Hit:2, -Aerial:Enemy)
...
* 格檔成功後長按格檔, 消耗霜雪在周圍產生風雪
    * 風雪造成大範圍傷害 (Hit:3, SuperArmor, +Aerial:Enemy) 並且額外增加敵人 Recovery  
